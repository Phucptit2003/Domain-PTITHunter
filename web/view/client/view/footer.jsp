		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 md-margin-bottom-40">
					...
					<h1>Contact PTITHunter.</h1>
					<br>
					<ul class="list-unstyled address-list margin-bottom-20">
						<li><i class="fa fa-angle-right"></i>Ha Noi - Viet Nam</li>
						<li><i class="fa fa-angle-right"></i>Phone: 0945 396023</li>
						<li><i class="fa fa-angle-right"></i>Hotline: 0123456789</li>
						<li><i class="fa fa-angle-right"></i>Email:
							phucle10503@gmail.com@gmail.com</li>
					</ul>

					<ul class="list-inline shop-social">
						<li><a href="https://www.facebook.com/phuc.in.12"><i class="fb rounded-md fa fa-facebook"></i></a></li>
