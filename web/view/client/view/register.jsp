	...
	<div class="wrapper">
		...
		<div class="breadcrumbs-v4">
			<div class="container">
				...
				<h1>
					High quality  <span class="shop-black">Vietnamese</span> product
				</h1>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-7 md-margin-bottom-50">
						<h2 class="welcome-title">Welcome to PTITHunter</h2>
						<p>Vietnamese Shoes</p>
						<br>
						<div class="row margin-bottom-50">
							<div class="col-sm-4 md-margin-bottom-20">
								<div class="site-statistics">
									<span>2,039</span> <small>Products</small>
								</div>
							</div>
							<div class="col-sm-4 md-margin-bottom-20">
								<div class="site-statistics">
									<span>5,283</span> <small>Reviews</small>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="site-statistics">
									<span>3k</span> <small>Sale</small>
								</div>
							</div>
						</div>
						<div class="members-number">
							<h3>
								Join more than <span class="shop-green">10,000</span> members
								in Viet Nam
							</h3>
							<img class="img-responsive" src="${url}/img/Ban_do_Viet_Nam.gif" alt="">
						</div>
					</div>
					...
					<div class="col-md-5">
						<form id="sky-form4" class="log-reg-block sky-form"
							...
							<label class="checkbox margin-bottom-10"> <input
								type="checkbox" name="checkbox" /> <i></i> Subscribe our facebook
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 md-margin-bottom-20">
						<h2>
							Feedback to <strong>PTITHunter</strong>
						</h2>
					</div>
					<div class="col-md-4">
